...
def run_test_generate_points_on_circle():
    ...
    # -------------------------------------------------------------------------
    # Test 2:
    expected = [rg.Point(152.0, 34), rg.Point(152.0, 34)]
    circle = rg.Circle(rg.Point(150, 34), 2)
...
def run_test_draw_points_on_circle():
    ...
    window3 = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(150, 40), 25)
    draw_points_on_circle(window3, circle, 3, 'blue')
    window.close_on_mouse_click()
...
def run_test_pizza():
    ...
    # -------------------------------------------------------------------------
    # Test 1:
    title = 'PIZZA test 4:  10 slices, thin (thickness=1) black lines.'
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(250, 200), 50)
    circle.fill_color = 'yellow'
    circle.outline_thickness = 4
    pizza(window, circle, 10, 'black', 1)
    window.close_on_mouse_click()
...
def run_test_polygon():
    ...
    polygon(window, circle, 4, 'blue', 7)
...
def run_test_fancy_polygon():
    ...
    # -------------------------------------------------------------------------
    title = ('FANCY POLYGON test 4:  20 pink lines on green circle,'
             + ' hops = 5.')
    window = rg.RoseWindow(480, 350, title)

    circle = rg.Circle(rg.Point(200, 150), 100)
    circle.fill_color = 'green'
    fancy_polygon(window, circle, 20, 5, 'pink', 7)
    window.close_on_mouse_click()
